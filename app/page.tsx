      ...
      <section className="relative bg-[#18253f] text-white py-24 px-6 pt-6">
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-center text-center">
          ...
          <nav className="w-full mb-6">
            <ul className="flex justify-center flex-wrap gap-x-5 gap-y-2">
          ...
          <Image src="/image.png" alt="ATMHS Logo" width={220} height={80} className="mb-6" />

          <h1 className="text-2xl md:text-4xl font-arabic font-bold mb-4 leading-snug">
      ...
      <div className="relative bg-white">
        ...
        <div className="flex flex-col items-center px-6 pt-8 pb-10 md:hidden">
          <Image
            ...
            "
          />
          <h2 className="mt-6 text-xl font-bold text-black text-center leading-snug">
